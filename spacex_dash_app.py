...
[ options.append({'label':v,"value":v}) for v in set(spacex_df['Launch Site'])]
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All':
        ...
        df = df.groupby(['Launch Site', 'class'])['class'].count()
...
def get_scatter_chart(entered_site, payload_range):
    ...
    filtered_df = spacex_df.copy()
    filtered_df = filtered_df[(min_payload <= filtered_df['Payload Mass (kg)']) & (max_payload >= filtered_df['Payload Mass (kg)'])]
